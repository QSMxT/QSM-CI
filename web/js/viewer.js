...
function renderChisepMetrics() {
  ...
  const groups = [
    ...
    ["χ+ paramagnetic (iron, veins)", [
      ...
      ["Region linearity", mv("para_region_linearity"), "num", "↓", "|1 − slope| of mean χ+ vs truth fitted across every segmented region — DGM linearity widened to the whole brain. 0 = linear quantification everywhere."],
      ["Region R²", mv("para_region_r2"), "num", "↑", "R² of that across-region fit: how much of the region-to-region variation in χ+ the reconstruction explains. 1 = regional values track the truth exactly."],
      ["Region bias", mv("para_region_bias"), "num", "↓", "Mean signed difference of the per-region means (χ+ recon − truth), ppm: the Bland–Altman bias. 0 is ideal; negative = systematic under-estimation."],
    ...
    ["χ− diamagnetic (calcium, myelin)", [
      ...
      ["Region linearity", mv("dia_region_linearity"), "num", "↓", "|1 − slope| of mean χ− vs truth fitted across every segmented region. 0 = linear quantification everywhere."],
      ["Region R²", mv("dia_region_r2"), "num", "↑", "R² of that across-region fit. χ− is where this exposes the most: a fair xSIM with R² near 0 means the regional values are not tracking the truth at all."],
      ["Region bias", mv("dia_region_bias"), "num", "↓", "Mean signed difference of the per-region means (χ− recon − truth), ppm: the Bland–Altman bias. 0 is ideal; negative = systematic under-estimation."],
