...
Builds the *same* phase → χ pipeline — field-mapping (romeo-qsmrs) → background-field removal
(vsharp-qsmrs) → dipole inversion (rts-qsmrs) — through all five engines and checks two things:
