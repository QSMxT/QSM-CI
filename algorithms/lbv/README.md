...
- **Reference:** Zhou et al., NMR Biomed 2014 · doi:[10.1002/nbm.3064](https://doi.org/10.1002/nbm.3064)

## How QSM-CI runs it

```bash
qsmxt bgremove lbv /input/totalfield.nii.gz -m /input/mask.nii.gz -o /output/localfield.nii.gz --b0-direction <B0>
```
