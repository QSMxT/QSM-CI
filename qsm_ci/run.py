...
def run_algo(client, docker_image, algo_name, bids_dir, work_dir, input_json):
...
def main():
    ...
    if not args.inputs_json:
        ...
        for input_json in parse_bids.parse_bids_directory(args.bids_dir):
            run_algo(client, docker_image, algo_name, args.bids_dir, work_dir, input_json)
    else:
